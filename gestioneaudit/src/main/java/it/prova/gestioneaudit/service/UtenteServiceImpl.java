...
public class UtenteServiceImpl implements UtenteService {
	...
	public void rimuovi(Utente utenteInstance) throws Exception {
		...
		try {
			...
			// impedisce rimozione se legato ad un audit
			if (!utenteDAO.findAllByUtente(utenteInstance).isEmpty()) {
				throw new Exception("Operazione illecita,l'utente non si può eliminare");
			}
			// eseguo quello che realmente devo fare
