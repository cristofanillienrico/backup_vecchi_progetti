...
public class GenereDAOImpl implements GenereDAO {
	...
	public List<Genere> findAllByCd(Cd cdInput) throws Exception {
		TypedQuery<Genere> query = entityManager
				.createQuery("select g from Genere g join g.cds as c where c=:cd", Genere.class)
				.setParameter("cd", cdInput);
	...
	public List<Genere> findByNomeAutore(String nomeAutoreInput) throws Exception {
		TypedQuery<Genere> query = entityManager
				.createQuery("select g from Genere g join g.cds as c where c.autore=:autore", Genere.class)
				.setParameter("autore", nomeAutoreInput);
