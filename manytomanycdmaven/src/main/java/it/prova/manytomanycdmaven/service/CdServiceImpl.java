...
public class CdServiceImpl implements CdService {
	...
	@Override
	public List<Cd> trovaTuttidaGenere(Genere genere) throws Exception {
		// questo è come una connection
		EntityManager entityManager = EntityManagerUtil.getEntityManager();
		...
		try {
			...
			// eseguo quello che realmente devo fare
			return cdDAO.findAllByGenere(genere);
		} catch (Exception e) {
			e.printStackTrace();
			throw e;
		} finally {
	...
	@Override
	public Cd doveTitoloUgualeA(String titolo) throws Exception {
		// questo è come una connection
				EntityManager entityManager = EntityManagerUtil.getEntityManager();
				...
				try {
					...
					// eseguo quello che realmente devo fare
					return cdDAO.whereTitoloIs(titolo);
